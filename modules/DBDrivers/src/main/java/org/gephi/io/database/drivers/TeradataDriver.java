/*
Copyright 2017 Jens Humrich
Authors : Jens Humrich <jens@humrich.de>
Website : http://www.humrich.de
...
public class TeradataDriver implements SQLDriver {
    ...
    public TeradataDriver() {
        try {
            // load the teradata-JDBC driver using the current class loader
            Class.forName("com.teradata.jdbc.TeraDriver");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TeradataDriver.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public Connection getConnection(String connectionUrl, String username, String passwd) throws SQLException {
        ...
        connectionUrl = "jdbc:default:" + url.substring(0, url.length() - 2);
